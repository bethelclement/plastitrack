                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <Link href="/" className="flex-shrink-0 flex items-center">
                            <img src="/plastitrackbes-logo.png" alt="PlastiTrackBES Logo" className="h-10 w-10 object-contain mr-2" />
                            <span className="font-bold text-xl text-primary">PlastiTrackBES</span>
                        </Link>
