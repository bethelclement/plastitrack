                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <Link href="/" className="flex-shrink-0 flex items-center">
                            <img src="/plastitrack-logo.png" alt="PlastiTrack Logo" className="h-10 w-10 object-contain mr-2" />
                            <span className="font-bold text-xl text-primary">PlastiTrack</span>
                        </Link>
