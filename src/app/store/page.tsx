...
const MOCK_PRODUCTS = [
    {
        id: "1",
        name: "Tyre Table Build (Premium)",
        description: "The upper part: Melted plastics. The bodice: Upcycled durable tyre. The down part: Chair legs for balance. An absolute innovation statement piece for your living room.",
        price: 35000,
        category: "Furniture and upcycled builds",
        images: ["/revamp-logo.png"],
        plastic_used: "Mixed rigid plastics & Tyre rubber",
        weight_diverted: 12.5,
        made_by: "Blessn Evea Signature (Durumi Hub)",
    },
    {
        id: "2",
        name: "Flat Trays with Handle for Serving",
        description: "Elegant, durable serving trays made entirely from compressed waste plastics. Perfect for events and home dining.",
        price: 8500,
